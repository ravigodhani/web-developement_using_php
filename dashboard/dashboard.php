    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><a href="https://sites.google.com/view/rameshwarminioilmill/home?authuser=1" target="_blank">Google Site</a></li>
                    <li class="list-group-item"><a href="https://www.linkedin.com/in/milan-bhalodiya-258a58287/">LinkedIn</a></li>
                    
                    <li class="list-group-item"><a href="https://github.com/milanbhalodiya12/" target="_blank">GitHub</a></li>
                </ul>
            </nav>
            <!-- Main content -->
            <main class="col-md-9">
                ...
                <div class="container">
                    ...
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
<button class="ocean-blue-button gradient-button"><a href="https://github.com/milanbhalodiya12/PHP/tree/main/Task_1" target="_blank">Task 1</a></button>
<button class="sunset-orange-button gradient-button"><a href="https://github.com/milanbhalodiya12/PHP/tree/main/Task_2" target="_blank">Task 2</a></button>
<button class="spring-green-button gradient-button"><a href="https://github.com/milanbhalodiya12/PHP/tree/main/Task_3" target="_blank">Task 3</a></button>
